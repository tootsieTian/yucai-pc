		...
		<div class="contair container-main" >
			...
			<div class="main" >
				...
				<div class="info" >
					...
					<div class="f-s" >
						...
						<div class="f-c f-s" >
							...
							<div class="f f-a f-s" >
								<div></div>
								<div  >
									<span style="color: #101010;font-weight: 500;margin-right: 14px;" >实付金额</span><Price></Price>
								</div>
					...
					<div  style="margin-top: 24px;margin-bottom: 86px;" class="f-s" >
						<div></div>
						<div class="f-s f-a" >
							<div> 还剩02:19:00</div>
							<div>  <el-button class="goplay f-a-j" >去付款</el-button> </div>
						</div>
					</div>
				</div>
